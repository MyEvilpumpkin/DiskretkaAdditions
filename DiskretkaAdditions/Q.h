...
public:
	...
	Q(const int);         // Конструктор преобразования int в Q (только для дебага)
	...
	friend Q ADD_QQ_Q(Q&, Q&);    // Q-5
	friend Q SUB_QQ_Q(Q&, Q&);    // Q-6
	friend Q MUL_QQ_Q(Q&, Q&);    // Q-7
	friend Q DIV_QQ_Q(Q&, Q&);    // Q-8
};
